...
#         지불해야 하는 금액의 최솟값이다.
#         카드 팩의 가격이 주어졌을 때, N개의 카드를 구매하기 위해 민규가 지불해야 하는 금액의 최솟값을 구하는
#         프로그램을 작성하시오. N개보다 많은 개수의 카드를 산 다음, 나머지 카드를 버려서 N개를 만드는 것은 불가능하다.
...
# 문제 소스) 백준 - https://www.acmicpc.net/problem/16194
